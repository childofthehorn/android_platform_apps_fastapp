...
////PACKAGES LIST 
       ...
       ArrayList<String> packLables = new ArrayList<String>;
...
/////ALL PACKAGES
       for(int i=0; i < packages.size(); i++) {
           ...
           //This is for Later when we display
           packLabels.add(label);
 
    	   String packageName = p.packageName;
    	   String versionName = p.versionName;
           String packageIntent = pm.getLaunchIntentForPackage(packageName).toString();
   ...
   setListAdapter(new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1, packLabels))
   }
